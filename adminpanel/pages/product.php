                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-12">                                        
                                        <div class="chheda-product-slider">
                                            <div><img src="images/product_detail/2.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                                            <div><img src="images/product_detail/2.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                                            <div><img src="images/product_detail/2.jpg" alt="" class="img-fluid blur-up lazyload"></div>
                            ...
                            <div class="col-lg-7 rtl-text">
                                <div class="product-right">
                                    <h2>kaju</h2>
                                    <h4><del>&#8377; 2800</del><span>10% off</span></h4>
                                    <h3>&#8377; 2520</h3>
                                    ...
                                    <h6 class="product-title size-text">select size / type <!-- <span><a href="" data-toggle="modal" data-target="#sizemodal">size chart</a></span> --></h6>
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                ...
                                                <li style="width:150px"><a href="#">Roasted & Salted</a></li>                                                
                                            </ul>
                                        </div>
                                        <h6 class="product-title size-text">select weight <!-- <span><a href="" data-toggle="modal" data-target="#sizemodal">size chart</a></span> --></h6>
                                        <!-- <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                        ...
                                        <div class="size-box">
                                            <ul>
                                                <li class="active"><a href="#">250gms</a></li>
                                                <li><a href="#">500gms</a></li>
                                                <li><a href="#">l000gms</a></li>                                                
                                            </ul>
                                        </div>
        ...
        <div class="row search-product">            
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="images/dry-fruits/almonds.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>                        
                    ...
                    <div class="product-detail">
                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div><a href="product-page(no-sidebar).html"><h6>Almonds</h6></a>
                        <h4>&#8377; 500.00</h4>                        
                    </div>
                </div>
            </div>
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="images/dry-fruits/anjeer.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>                        
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
                    <div class="product-detail">
                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div><a href="product-page(no-sidebar).html"><h6>Anjeer</h6></a>
                        <h4>&#8377; 500.00</h4>
            ...
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="images/dry-fruits/cashewnuts.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div> 
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
                    <div class="product-detail">
                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div><a href="product-page(no-sidebar).html"><h6>Cashewnuts</h6></a>
                        <h4>&#8377; 500.00</h4>
            ...
            <div class="col-xl-2 col-md-4 col-sm-6">
                <div class="product-box">
                    <div class="img-wrapper">
                        <div class="front">
                            <a href="#"><img src="images/dry-fruits/pista.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                        </div>                        
                        <div class="cart-info cart-wrap">
                            <button data-toggle="modal" data-target="#addtocart"  title="Add to cart"><i class="ti-shopping-cart" ></i></button> <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a> <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a> <a href="compare.html" title="Compare"><i class="ti-reload" aria-hidden="true"></i></a></div>
                    </div>
                    <div class="product-detail">
                        <div class="rating"><i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i> <i class="fa fa-star"></i></div><a href="product-page(no-sidebar).html"><h6>Pista</h6></a>
                        <h4>&#8377; 500.00</h4>
