    ...
    <div class="slide-1 home-slider">
        <div>
            <div class="home text-center">
                <img src="images/home-banner/banner-1.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <!-- <h4>save 10%</h4> -->
                                    <h1>Wide variety of almonds</h1><a href="#" class="btn btn-solid">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <div class="home text-center">
                <img src="images/home-banner/banner-2.jpg" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    <!-- <h4>save upto 10%</h4> -->
                                    <h1>A Little Bliss in Every Bite</h1><a href="#" class="btn btn-solid">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="product-5 product-m no-arrow">
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="images/dry-fruits/almonds.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                        ...
                        <div class="product-detail text-center">
                            ...
                            <h4>&#8377; 2500 per/kg <del>&#8377; 3100 per/kg</del></h4>
                        </div>
                    </div>
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="images/dry-fruits/cashewnuts.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="images/dry-fruits/pista.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>                                
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="images/dry-fruits/anjeer.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>                                
                    ...
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
                            <div class="lable-block"><span class="lable3">new</span> <span class="lable4">on sale</span></div>
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="images/sweets/kesar-kajukatli.jpg" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>                                
                        ...
                        <div class="product-detail text-center">
                            ...
                            <h4>&#8377; 1200 per/kg <del>&#8377; 2100 per/kg</del></h4>
                        </div>
                    </div>
                    <div class="product-box product-wrap">
                        <div class="img-wrapper">
...
<section class="p-0">
    <div class="full-banner parallax text-left p-left">
        <img src="images/parallax/home.jpg" alt="" class="bg-img blur-up lazyload">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="banner-contain">
                        <h3>highest quality of products</h3>
                        <h2>Since 1940</h2>                        
                        <!-- <h4>special offer</h4> -->
                    </div>
                </div>
...
<section class="game-product ratio_square  pt-0 section-b-space">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="product-para">
                    <p class="text-center"> Browse through our wide range of products on offer, pick what you want and where and you're done! </p>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div id="tab-4" class="tab-content active default" >
                            <div class=" no-slider five-product row">
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/1.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>                                            
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Assorted Sweets</h6></a>
                                        <h4>&#8377; 500</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/2.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>                                            
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/3.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/4.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                ...
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/5.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                        ...
                        <div id="tab-5" class="tab-content">
                            <div class=" no-slider five-product row">
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/6.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Dhokla</h6></a>
                                        <h4>&#8377; 400 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/9.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Malai Sandwich</h6></a>
                                        <h4>&#8377; 1500 Per/Kg </h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/7.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Khandvi</h6></a>
                                        <h4>&#8377; 600 Per/Kg <del>&#8377; 680 Per/Kg</del></h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/8.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Aluwadi</h6></a>
                                        <h4>&#8377; 750 Per/Kg <del>&#8377; 900 Per/Kg</del></h4>
                                    </div>
                                </div>                                
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/10.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Dryfruit Karanji</h6></a>
                                        <h4>&#8377; 800 Per/Kg </h4>
                                    </div>
                                </div>
                                <div class="product-box">
                            ...
                            <div class=" no-slider five-product row">
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/11.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Anjeer</h6></a>
                                        <h4>&#8377; 2500.00 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/12.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Black Kismis</h6></a>
                                        <h4>&#8377; 900 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/13.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Kaju</h6></a>
                                        <h4>&#8377; 2200 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        <div class="front">
                                        <a href="product-page(no-sidebar).html"><img src="images/products/14.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Farsan</h6></a>
                                        <h4>&#8377; 500 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
                                    <div class="img-wrapper">
                                        ...
                                        <div class="front">
                                            <a href="product-page(no-sidebar).html"><img src="images/products/15.jpg" class="img-fluid bg-img blur-up lazyload" alt=""></a>
                                        </div>
                                        <div class="cart-info cart-wrap">
                                            <a href="javascript:void(0)" title="Add to Wishlist"><i class="ti-heart" aria-hidden="true"></i></a>
                                            <a href="#" data-toggle="modal" data-target="#quick-view" title="Quick View"><i class="ti-search" aria-hidden="true"></i></a>
                                    ...
                                    <div class="product-detail">
                                        ...
                                        <a href="product-page(no-sidebar).html"><h6>Bakarwadi</h6></a>
                                        <h4>&#8377; 800 Per/Kg</h4>
                                    </div>
                                </div>
                                <div class="product-box">
